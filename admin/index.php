                ...
                <div class="justify-between">
                    <div class="mt-8">
                        <li class="list-none active">
                            <i class=" fa-regular fa-house text-gray-500 text-sm"></i><a
                                class="ml-2 text-gray-500 text-sm nav-link" href="dashboard.php">Dashboard</a>
                        </li>
                        ...
                        <li class=" list-none mt-4">
                            <i class="fa-regular fa-square-poll-vertical text-gray-500 text-sm"></i><a
                                class="ml-2 text-gray-500 text-sm nav-link" href="semester.php">Semester</a>
                        </li>
                        <li class="list-none mt-4">
                            <i class="fa-regular fa-square-poll-vertical text-gray-500 text-sm"></i><a
                                class="ml-2 text-gray-500 text-sm nav-link " href="accadmicYear.php">Accademic Year</a>
                        </li>
                        <li class=" list-none mt-4">
                            <i class="fa-regular fa-briefcase text-gray-500 text-sm"></i><a
                                class="ml-2 text-gray-500 text-sm nav-link" href="teacher_reg.php">Teachers</a>
                        </li>

                        <li class=" list-none mt-4">
                            <i class="fa-regular fa-briefcase text-gray-500 text-sm"></i><a
                                class="ml-2 text-gray-500 text-sm nav-link" href="teacher_class_assigment.php">Teacher
                                Classes</a>
                        </li>
                        <li class=" list-none mt-4">
                            <i class="fa-regular fa-users text-gray-500 text-sm"></i><a
                                class="ml-2 text-gray-500 text-sm nav-link" href="students_reg.php">Students</a>
                        </li>
                        <li class=" list-none mt-4">
                            <i class="fa-regular fa-users text-gray-500 text-sm"></i><a
                                class="ml-2 text-gray-500 text-sm nav-link"
                                href="student_subject_registeration.php">Student
                                Subjects</a>
                        </li>
                        <li class=" list-none mt-4">
                            <i class="fa-regular fa-users text-gray-500 text-sm"></i><a
                                class="ml-2 text-gray-500 text-sm nav-link" href="student_class_reg.php">Student
                                Classes</a>
                        </li>

                        <li class=" list-none mt-4">
                            <i class="fa-regular fa-user text-gray-500 text-sm"></i><a
                                class="ml-2 text-gray-500 text-sm nav-link" href="parents_reg.php">Parents</a>
                        </li>
                        <li class=" list-none mt-4">
                            <i class="fa-regular fa-square-poll-vertical text-gray-500 text-sm"></i><a
                                class="ml-2 text-gray-500 text-sm nav-link" href="results.php">Results</a>
                        </li>
