...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($checkResult) > 0) {
        ...
        $query = "INSERT INTO `semester`(`name`,`status`, `date`) VALUES ('$semester','$status', '$date')";
...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $delete = mysqli_query($connection,"DELETE FROM `semester` WHERE `id` = $id" );
                    ...
                    ?>
                        <tbody class="text-[13px] text-gray-600">
                            <tr class="even:bg-[#e9e3ff] h-10">
                                ...
                                <td>
                                    <a href="semester.php?id=<?php echo $row['id'] ?>">
                                ...
                                <td>
                                    <div class="flex gap-[2px]">
                                        ...
                                        <a href="semester.php?delete=<?php echo $row['id'] ?>">
