...
$query = "SELECT * FROM `teacherclass` LIMIT $offset, $recordsPerPage";
$teacher_details = mysqli_query($connection, $query);

// Query to get the total count of records
$totalRecordsQuery = "SELECT COUNT(*) AS total FROM `teacherclass`";
                    ...
                    <tr class="even:bg-[#e9e3ff] h-10">
                        ...
                        <td>
                            <?php
                                    ...
                                    $query = "SELECT name FROM teachers WHERE id = '$subjectId'";
